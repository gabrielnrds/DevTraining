...
public class RepositorioProfessores {
    ...
    public void cadastrar(Professor professor) {
        ...
        if (existeProfessorComId(professor.getCodigoDeFuncionario())) {
    ...
    //Método para duplicar o array casso fique cheio 
...
void carregarDados() {
    ...
    // Método para criarProfessor A partir da linha
        ...
        try {
            ...
            if (dados.length >= 9) {
                ...
                if (dados[5].matches("\\d+") && dados[6].matches("\\d+")) {
                    ...
                    return new Professor(nome, telefone, email, cpf, idade, codigo, turno, salario);
                } else {
